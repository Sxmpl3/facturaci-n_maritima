    ...
    return (
        <div className="space-y-6">
            <Heading
                ...
                description="Borra permanentemente tu cuenta y todos sus datos asociados"
            />
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            Al eliminar la cuenta se borrarán de forma permanente todos sus recursos y datos.
                            Introduce tu contraseña para confirmar el borrado definitivo.
                        </DialogDescription>
