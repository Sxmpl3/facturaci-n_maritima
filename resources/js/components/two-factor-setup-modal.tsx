    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'La verificación en dos pasos ya está activa. Escanea el QR o introduce la clave manual en tu aplicación de autenticación.',
                buttonText: 'Cerrar',
            };
        }
        ...
        if (showVerificationStep) {
            return {
                ...
                description: 'Introduce el código de 6 dígitos que aparece en tu aplicación de autenticación',
        ...
        return {
            ...
            description:
                'Escanea el QR o introduce la clave manual en tu aplicación de autenticación para completar la activación',
            buttonText: 'Continuar',
        };
